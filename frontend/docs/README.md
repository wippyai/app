...
| [agent-artifacts.md](agent-artifacts.md) | CreateArtifact tool: three content modes, display modes, embed token rule, inline component shortcut, SPA page sizing | Writing or debugging an agent trait that creates artifacts |
