...
import App from './app/dam-details-flap.vue'
import stylesText from './styles.css?inline'
import pkg from '../package.json'

class DamDetailsFlapElement extends WippyVueElement<ComponentProps, Events> {
...
export async function webComponent() {
  return DamDetailsFlapElement
}

define(import.meta.url, DamDetailsFlapElement)
