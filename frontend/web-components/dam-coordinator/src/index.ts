...
import App from './app/dam-coordinator.vue'
import stylesText from './styles.css?inline'
import pkg from '../package.json'

class DamCoordinatorElement extends WippyVueElement<ComponentProps, Events> {
...
export async function webComponent() {
  return DamCoordinatorElement
}

define(import.meta.url, DamCoordinatorElement)
