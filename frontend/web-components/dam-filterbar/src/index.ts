...
import App from './app/dam-filterbar.vue'
import stylesText from './styles.css?inline'
import pkg from '../package.json'

class DamFilterbarElement extends WippyVueElement<ComponentProps, Events> {
...
export async function webComponent() {
  return DamFilterbarElement
}

define(import.meta.url, DamFilterbarElement)
