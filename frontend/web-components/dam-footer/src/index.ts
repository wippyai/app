...
import App from './app/dam-footer.vue'
import stylesText from './styles.css?inline'
import pkg from '../package.json'

class DamFooterElement extends WippyVueElement<ComponentProps, Events> {
...
export async function webComponent() {
  return DamFooterElement
}

define(import.meta.url, DamFooterElement)
