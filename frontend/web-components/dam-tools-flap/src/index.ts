...
import App from './app/dam-tools-flap.vue'
import stylesText from './styles.css?inline'
import pkg from '../package.json'

class DamToolsFlapElement extends WippyVueElement<ComponentProps, Events> {
...
export async function webComponent() {
  return DamToolsFlapElement
}

define(import.meta.url, DamToolsFlapElement)
