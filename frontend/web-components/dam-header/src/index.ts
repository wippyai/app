...
import App from './app/dam-header.vue'
import stylesText from './styles.css?inline'
import pkg from '../package.json'

class DamHeaderElement extends WippyVueElement<ComponentProps, Events> {
...
export async function webComponent() {
  return DamHeaderElement
}

define(import.meta.url, DamHeaderElement)
