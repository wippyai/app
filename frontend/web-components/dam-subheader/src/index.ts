...
import App from './app/dam-subheader.vue'
import stylesText from './styles.css?inline'
import pkg from '../package.json'

class DamSubheaderElement extends WippyVueElement<ComponentProps, Events> {
...
export async function webComponent() {
  return DamSubheaderElement
}

define(import.meta.url, DamSubheaderElement)
