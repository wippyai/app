...
import App from './app/dam-toolbar.vue'
import stylesText from './styles.css?inline'
import pkg from '../package.json'

class DamToolbarElement extends WippyVueElement<ComponentProps, Events> {
...
export async function webComponent() {
  return DamToolbarElement
}

define(import.meta.url, DamToolbarElement)
