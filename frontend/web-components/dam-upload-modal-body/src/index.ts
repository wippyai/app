...
import App from './app/dam-upload-modal-body.vue'
import stylesText from './styles.css?inline'
import pkg from '../package.json'

class DamUploadModalBodyElement extends WippyVueElement<ComponentProps, Events> {
...
export async function webComponent() {
  return DamUploadModalBodyElement
}

define(import.meta.url, DamUploadModalBodyElement)
